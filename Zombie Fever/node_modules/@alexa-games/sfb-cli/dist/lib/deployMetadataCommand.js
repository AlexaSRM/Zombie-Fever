...
class DeployMetadataCommand {
    ...
    async run() {
        ...
        await utilities_1.Utilities.runCommandInDirectoryAsync(utilities_1.Utilities.npxBin, ['ask', 'deploy', '--target', 'skill', '--no-wait', '--force', '--profile', askProfileName], configDirs.askSkillFullPath, this.stdOutput, { shell: true });
        await utilities_1.Utilities.runCommandInDirectoryAsync(utilities_1.Utilities.npxBin, ['ask', 'deploy', '--target', 'model', '--no-wait', '--force', '--profile', askProfileName], configDirs.askSkillFullPath, this.stdOutput, { shell: true });
        await utilities_1.Utilities.runCommandInDirectoryAsync(utilities_1.Utilities.npxBin, ['ask', 'deploy', '--target', 'isp', '--no-wait', '--force', '--profile', askProfileName], configDirs.askSkillFullPath, this.stdOutput, { shell: true });
...
exports.DeployMetadataCommand = DeployMetadataCommand;
//# sourceMappingURL=deployMetadataCommand.js.map